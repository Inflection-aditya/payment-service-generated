...
Welcome to the comprehensive API documentation for the payment-service application.
...
- **Framework**: Express
- **Database**: paymentservice_d with TypeORM
...
```json
{
  ...
  "timestamp": "2025-10-30T17:01:39.500Z"
}
```
...
2. **Setup Database**: Configure your paymentservice_d database and update the connection string
